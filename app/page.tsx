...
import { prizes, events } from './data';
...
function ChallengeApp() {
    ...
    if (allCorrect) {
      ...
      setQuizFeedback({
        ...
        description: `Folgende Fragen sind nicht richtig beantwortet:
          ${
            !question1Correct && !question2Correct
              ? 'Frage 1 und Frage 2'
              : ''
          }
  ...
  return (
    <main className="min-h-screen">
                    ...
                    <CardContent className="flex items-center md:w-2/4 h-full">
                      <div className="flex flex-col justify-center items-center text-center h-full">
                        ...
                        <p className="text-white/80">
                          Neben coolen Goodies sind 10 Dosen Red Bull
                          für maximale Produktivität enthalten 🚀
                        </p>
                      </div>
                    </CardContent>
                      ...
                      >
                        ...
                        <CardContent className="flex flex-col items-center justify-center pt-6 h-[320px]">
                          ...
                          <div className="flex-1 w-full flex items-center justify-center">
                            <img
                              src={
                                prizes[0].image || '/placeholder.svg'
                              }
                              alt={prizes[0].title}
                      ...
                      >
                        ...
                        <CardContent className="flex flex-col items-center pt-6">
                          ...
                          <div className="w-full h-36 overflow-hidden flex items-center justify-center">
                            <img
                              src={
                                prizes[1].image || '/placeholder.svg'
                              }
                              alt={prizes[1].title}
                      ...
                      >
                        ...
                        <CardContent className="flex flex-col items-center pt-6">
                          ...
                          <div className="w-full h-36 mt-5 mb-6 overflow-hidden rounded-xl flex items-center justify-center">
                            <img
                              src={
                                prizes[2].image || '/placeholder.svg'
                              }
                              alt={prizes[2].title}
                  ...
                  <SwiperSlide>
                    <div className="flex items-center justify-center h-full">
                      ...
                      >
                        ...
                        <CardContent className="flex flex-col items-center pt-6">
                          <h3 className="text-xl font-semibold text-center mb-6">
                            AC Goodie Bag inkl. 10 Dosen Red Bull
                          </h3>
                          <p className="text-center text-white/80 mb-6">
                            Neben coolen Goodies sind 10 Dosen Red
                            Bull für maximale Produktivität enthalten
                            🚀
                          </p>
                          ...
                          <CardContent className="p-0">
                            ...
                            {game.id === 1 && (
                              <div className="space-y-4">
                                <p className="text-lg">
                                  ...
                                  <img
                                    src="https://raw.githubusercontent.com/AcademyConsult/HSM_Game/main/public/leoKopf.png"
                                    alt="Leo der Löwe"
                            ...
                            {game.id === 2 && (
                              <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                  <h3 className="font-semibold text-lg">
                                    2. Welcher der folgenden Begriffe
                                    entspricht{' '}
                                    ...
                                    >
                                      <div className="p-6 rounded-lg">
                                        <p className="font-medium text-xl mb-4 text-black">
                                          ...
                                          Academy Consult seit der
                                          Gründung bis zum 01.01.2025
                                          aufgenommen?{' '}
                                        </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-2 my-4">
                        ...
                        >
                          ...
                          <a
                            href="https://polydactyl-course-f91.notion.site/Teilnahmebedingungen-1cd3d6763f7b80ea9060d5f84e1649d3"
                            target="_blank"
                          ...
                          und
                          <a
                            href="https://polydactyl-course-f91.notion.site/Datenschutzbestimmungen-1d03d6763f7b80af8b50e2362a25c4c7?pvs=74"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[#993333] hover:underline"
                          >
      ...
      <section
        id="events-section"
        className="bg-white pt-12 pb-6 md:pt-24"
      >
